...
$allowed = array('127.0.0.1', '207.10.37.209', '174.103.122.73', '98.28.235.179','74.142.251.78','192.168.1.104');
...
switch($_SERVER['HTTP_HOST']) {
	...
	case 'qa-mens.rods.com':
		$mageRunCode = 'mens';
		$mageRunType = 'store';
		break;
	case 'outlet.rods.com':
	case 'qa-outlet.rods.com':
