...
IGNORE_TABLES=( dataflow_batch_export dataflow_batch_import log_customer log_quote log_summary log_summary_type log_url log_url_info log_visitor log_visitor_info log_visitor_online report_event index_event enterprise_logging_event_changes core_cache core_cache_tag core_session core_cache_tag listrak_remarketing_log )
...
[ $? -eq 0 ] && GZIP_CMD="pigz" || GZIP_CMD="xz"

IGNORE_STRING=""
DBHOST="10.250.143.104"
DBUSER="rodsmagento"
DBPASS=$(getParam "password" "sanitise" )
DBNAME="rodsmagento"
TABLE_PREFIX=$(getParam "table_prefix")
[ -f $TMP_FILE ] && rm $TMP_FILE
[[ ! "$OPT_z" == "" ]] && DUMP_FILE="$DUMP_FILE"".xz"
